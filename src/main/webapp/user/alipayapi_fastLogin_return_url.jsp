<%@page import="com.bnool.anishop.core.FrontContainer"%>
<%@page import="com.bnool.anishop.web.action.manage.account.AccountAction"%>
<%@page import="org.slf4j.LoggerFactory"%>
<%@page import="org.slf4j.Logger"%>
<%@page import="com.bnool.anishop.services.front.account.AccountService"%>
<%@page
	import="org.springframework.web.context.support.WebApplicationContextUtils"%>
<%@page import="org.springframework.web.context.WebApplicationContext"%>
<%@page import="com.bnool.anishop.core.front.SystemManager"%>
<%@page import="com.bnool.anishop.services.front.account.bean.LoginTypeEnum"%>
<%@page import="com.bnool.anishop.services.front.account.bean.Account"%>
<%@page import="com.bnool.anishop.core.ManageContainer"%>
<%@page import="com.bnool.anishop.core.pay.alipay.alipayescow.util.AlipayNotify"%>
<%
	/* *
	 功能：支付宝页面跳转同步通知页面
	 版本：3.2
